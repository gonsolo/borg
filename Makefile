...
help:
	...
	@echo " 5.     	distro: 		Make Linux kernel and bootloader. 			setup"
	@echo " 6.     	xdma_install: 		Install XDMA drivers. 					-"
	@echo " 7.     	program_device		Flash the FPGA with the hex file. 			bitstream"
	@echo " 8.     	xdma_load:		Load xmda drivers. 					xdma_install"
